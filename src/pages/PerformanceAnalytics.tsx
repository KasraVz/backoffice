...
const trendData = [
  ...
  { date: "Jul 16", score: 78 },
  { date: "Jul 17", score: 75 },
  { date: "Jul 18", score: 81 },
  { date: "Jul 19", score: 79 },
  { date: "Jul 20", score: 82 },
  { date: "Jul 21", score: 80 },
  { date: "Jul 22", score: 85 }
];

const behavioralCodeData = [
  { code: "Resilience", score: 85 },
  { code: "Strategy", score: 78 },
  { code: "Leadership", score: 82 },
  { code: "Innovation", score: 76 },
  { code: "Communication", score: 88 },
  { code: "Problem Solving", score: 79 },
  { code: "Decision Making", score: 84 },
  { code: "Team Building", score: 77 },
  { code: "Adaptability", score: 81 },
  { code: "Critical Thinking", score: 83 },
  { code: "Emotional Intelligence", score: 86 },
  { code: "Risk Management", score: 74 }
];

const difficultQuestions = [
  { rank: 1, title: "When faced with unexpected negative cash flow...", avgScore: 45 },
  { rank: 2, title: "Which legal structure provides the most liability protection...", avgScore: 52 },
  { rank: 3, title: "Describe the best approach to calculating TAM, SAM, and SOM...", avgScore: 55 },
  { rank: 4, title: "How should equity be distributed among co-founders...", avgScore: 58 },
  { rank: 5, title: "What are the key metrics for measuring product-market fit...", avgScore: 61 }
];

const easyQuestions = [
  { rank: 1, title: "Is a clear value proposition important?", avgScore: 98 },
  { rank: 2, title: "Should a startup have a business plan?", avgScore: 95 },
  { rank: 3, title: "What does MVP stand for?", avgScore: 94 },
  { rank: 4, title: "Is customer feedback valuable for product development?", avgScore: 93 },
  { rank: 5, title: "Should startups focus on solving real problems?", avgScore: 92 }
];
            ...
            <div className="ml-auto flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex gap-1">
                  <Button
                    variant={selectedDateRange === "last-30" ? "default" : "outline"}
                    size="sm"
                    onClick={() => handleQuickDateSelect("last-30")}
                  >
                    Last 30 Days
                  </Button>
                  <Button
                    variant={selectedDateRange === "last-90" ? "default" : "outline"}
                    size="sm"
                    onClick={() => handleQuickDateSelect("last-90")}
                  >
                    Last 90 Days
                  </Button>
                  <Button
                    variant={selectedDateRange === "all-time" ? "default" : "outline"}
                    size="sm"
                    onClick={() => handleQuickDateSelect("all-time")}
                  >
                    All Time
                  </Button>
                </div>
